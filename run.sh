...
# srun --gres=gpu:1 python -u main_bnn_onestep.py main --data_name="stl10" --bnn="mix" --use_gpu=True --batch_size=32 --lr=1e-3
# srun --gres=gpu:1 python -u main_bnn_onestep.py main --data_name="svhn" --bnn="mix" --use_gpu=True --batch_size=32 --lr=1e-3
...
# srun --gres=gpu:1 python -u main_bnn_tl.py main --data_name="stl10" --bnn="mix" --use_gpu=True --batch_size=32 --lr=1e-3 --weight_decay=1e-5
# srun --gres=gpu:1 python -u main_bnn_tl.py main --data_name="svhn" --bnn="snr" --use_gpu=True --batch_size=32 --lr=1e-3
...
# srun --gres=gpu:1 python -u main_spl.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="spl"
# srun --gres=gpu:1 python -u main_spl.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="spl"
...
# srun --gres=gpu:1 python -u main_spl.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="spcl"
# srun --gres=gpu:1 python -u main_spl.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="spcl"
...
# srun --gres=gpu:1 python -u main_spl.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="splir"
# srun --gres=gpu:1 python -u main_spl.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3 --spl="splir"
...
# srun --gres=gpu:1 python -u main_cltl.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3
# srun --gres=gpu:1 python -u main_cltl.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3
...
# srun --gres=gpu:1 python -u main_mentornet.py main_train_mentornet --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3 --noise_ratio=0.2
# srun --gres=gpu:1 python -u main_mentornet.py main --data_name="stl10" --use_gpu=True --batch_size=64 --lr=1e-3 --noise_ratio=0.0

# srun --gres=gpu:1 python -u main_mentornet.py main_train_mentornet --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3 --noise_ratio=0.2
# srun --gres=gpu:1 python -u main_mentornet.py main --data_name="svhn" --use_gpu=True --batch_size=64 --lr=1e-3 --noise_ratio=0.0
...
# srun --gres=gpu:1 python -u main_curriculumNet.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3
# srun --gres=gpu:1 python -u main_curriculumNet.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3
...
# srun --gres=gpu:1 python -u main_dataparam_cl.py main --data_name="stl10" --use_gpu=True --batch_size=32 --lr=1e-3 --weight_decay=1e-4
# srun --gres=gpu:1 python -u main_dataparam_cl.py main --data_name="svhn" --use_gpu=True --batch_size=32 --lr=1e-3 --weight_decay=1e-4
